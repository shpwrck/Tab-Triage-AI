...
export function tabCapMessage(cap) {
  return `Free plan triages up to ${cap.limit} tabs at a time. This run uses the first ${cap.sentCount} of ${cap.originalCount} selected tabs. Buy lifetime for unlimited.`;
}
