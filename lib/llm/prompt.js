...
1. Group the tabs into 2–6 groups by INTENT. Each group's \`label\` must be SHORT and DISTINCTIVE so the user can tell groups apart even when they're collapsed in the Chrome tab strip (only the first ~12 characters are visible when collapsed).
...
2. For each group, write a 3-bullet summary (each bullet ≤ 18 words) describing:
   • what the user appears to be doing in this group
