...
export const PROVIDERS = {
  ...
  openai: {
    ...
    supportsBaseUrl: true,
    keyHelp: "Works with OpenAI, OpenRouter, Groq, Together, Fireworks, Ollama (compat mode), LM Studio, vLLM. For non-OpenAI providers, set a Base URL like https://openrouter.ai/api/v1.",
  },
  gemini: {
    label: "Google (Gemini)",
    keyPrefix: "",
